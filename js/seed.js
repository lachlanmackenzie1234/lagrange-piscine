...
const CHEM_RANGES = {
  ...
  const RESIDENCES = [
    ...
    {
      code: 'EP', name: 'Eden Parc',
      mapsQuery: 'Lagrange Vacances Eden Parc Golf, Lacanau-Océan',
      note: 'Eden Parc Golf — Rue du Birdie / Rue Eden Parc. Unit codes carry a plot number (e.g. 6B/75).',
    },
    {
    ...
    {
      code: 'GP', name: 'GP — to confirm',
      mapsQuery: 'Lacanau-Océan golf',
      note: 'Residence code "GP" — full name not yet known (Green Parc?). No plan provided yet.',
      verify: true,
    },
    {
      code: 'HO', name: 'HO — to confirm',
      mapsQuery: 'Lacanau-Océan',
      note: 'Residence code "HO" — full name not yet known. No plan provided yet.',
      verify: true,
    },
  ];
