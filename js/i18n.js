...
const I18n = (() => {
  ...
  const STR = {
    en: {
      ...
      // team sync
      op_title: 'Username', set_team: 'Team', set_backup: 'Backup', set_app: 'App', export_row: 'Export', export_row_sub: 'backup, data only, readings, notes', version_word: 'Version', theme_title: 'Theme', theme_auto: 'Auto', theme_light: 'Light', theme_dark: 'Dark', style_title: 'Style', style_ocean: 'Ocean', style_minimal: 'Minimal', style_tableau: 'Table', style_pixel: 'Pixel', update_short: 'Update', season_boundary: 'Season boundary', season_open_n: '{n} open pools',
    ...
    fr: {
      ...
      // synchro équipe
      op_title: 'Nom d’utilisateur', set_team: 'Équipe', set_backup: 'Sauvegarde', set_app: 'Application', export_row: 'Exporter', export_row_sub: 'sauvegarde, données seules, mesures, notes', version_word: 'Version', theme_title: 'Thème', theme_auto: 'Auto', theme_light: 'Clair', theme_dark: 'Sombre', style_title: 'Style', style_ocean: 'Océan', style_minimal: 'Minimal', style_tableau: 'Tableau', style_pixel: 'Pixel', update_short: 'Mettre à jour', season_boundary: 'Limite de saison', season_open_n: '{n} piscines ouvertes',
