...
const I18n = (() => {
  ...
  const STR = {
    en: {
      ...
      notes_section: 'Notes',
      add_note: '+ Note',
      note_ph: 'e.g. check AG 8 — going green · tile to fix · skimmer broke · set to auto',
    ...
    fr: {
      ...
      notes_section: 'Notes',
      add_note: '+ Note',
      note_ph: 'ex. vérifier AG 8 — verdit · carreau à réparer · skimmer cassé · mettre en auto',
