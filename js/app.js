...
(() => {
  ...
  function loadGame() {
    ...
    const chain = [['js/pixelart.js', 'PixelArt'], ['js/maps.js', 'PoolMaps'], ['js/keeper-art.js', 'KeeperArt'], ['js/game-motion.js', 'QuestMotion'], ['js/hub-art.js', 'QuestHubArt'], ['js/living-world.js', 'QuestWorld'], ['js/game.js', 'Game']];
    const next = () => {
