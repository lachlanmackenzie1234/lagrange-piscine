...
(() => {
  ...
  function loadGame() {
    ...
    const chain = [['js/pixelart.js', 'PixelArt'], ['js/maps.js', 'PoolMaps'], ['js/pixel-surface.js', 'PixelSurface'], ['js/keeper-art.js', 'KeeperArt'], ['js/game-motion.js', 'QuestMotion'], ['js/hub-art.js', 'QuestHubArt'], ['js/living-world.js', 'QuestWorld'], ['js/game.js', 'Game']];
    const next = () => {
  ...
  const APP_VERSION = 'v0.103.0'; // semver display; keep in step with sw.js VERSION
