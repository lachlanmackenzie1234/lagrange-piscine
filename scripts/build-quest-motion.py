#!/usr/bin/env python3
"""Pack the published Pocket Coast motion designs into five browser sprite pages."""
...
families={'monsters':['monster'],'auras':['set-aura','rarity-aura'],'effects':['action-fx','event-fx','service-fx'],'water':['water'],'loot':['loot']}
